...
![Node-location](./Images/Nodejs-location.png)

Install Node.js on the server with the command below  
`sudo apt-get install -y nodejs`
![Node-install](./Images/Nodejs-install.png)
...
![Exp-install](./Images/Exp-Install.png)
...
![Node-output](./Images/nodejs-output.png)
...
![Mongodb-overview](./Images/Mongodb-overview.png)

- Locate Network Access by the left panel and allow access to the MongoDB database from anywhere (Not secure, but it is ideal for testing)

![mongodb-Net-Acc](./Images/Mongodb-network-access.png)

![mongodn-net-acc2](./Images/Mongodb-network-access2.png)

- Create a MongoDB database and collection inside mLab

![Mongodb-coll](./Images/Mongodb-collection.png)
...
![Mongodb-str](./Images/Mongodb-string.png)

***Heres's how to get your connection string***

![String-step1](./Images/String-step1.png)

![String-step2](./Images/String-step2.png)

![String-step3](./Images/String-step3.png)
...
```
 ...
 ![Index-update](./Images/Index.js%20update.png)
...
![Mongodb-indexjs](./Images/Mongodb-indexjs.png)
...
![Postman-new](./Images/New-postman.png)
...
![run-dev](./Images/npm-run-dev.png)
...
```
![List-todojs](./Images/ListTodo.png)
...
```
![index-css](./Images/indexxcss.png)
 
Go to the Todo directory and run `npm run dev`

![npm-rundev](./Images/npm-run-dev.png)
 
Assuming no errors when saving all these files, our To-Do app should be ready and fully functional with the functionality discussed earlier: creating a task, deleting a task and viewing all your tasks.

![Todo-frontend1](./Images/Todo-frontend.png)

![Todo-frontend2](./Images/Todo-frontend%202.png)

![Todo-frontend3](./Images/Todo-frontend%203.png)